...
<section class="content">
  <div class="container">
    <div class="books-wrap">
      ...
      <div class="go-to">
        <p><fmt:message key="title.librarian"/></p>
        <div class="registration-info">
          <p><span><fmt:message key="title.user"/>:</span>
            <span>${sessionScope.loggedUser.name} ${sessionScope.loggedUser.surname}</span></p>
          <p><span><fmt:message key="title.role"/>:</span>
            <span>${sessionScope.loggedUser.role.name}</span></p>
          <p><span><fmt:message key="title.position"/>:</span><span><fmt:message key="title.position.librarian"/>
          </span></p>
        </div>
